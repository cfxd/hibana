...
function toggleRecoverPasswordForm() {
  document.querySelector(selectors.recoverPasswordForm).classList.toggle('UtilityHide');
  document.querySelector(selectors.loginForm).classList.toggle('UtilityHide');
}
...
function resetPasswordSuccess() {
  ...
  if (document.querySelector(selectors.formState)) {
    document.querySelector(selectors.resetSuccess).classList.remove('UtilityHide');
  }
}
